...
#This scriot calculates the dip statistic D, the associated p-value, mean of the distribution, media, of the distribution, the first quartile, the 3 quartile, and the standard deviation.
